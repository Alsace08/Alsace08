...
- 🌱 My research interests are Natural Language Processing, especially **Complex Reasoning** and **Discrete Generation**(Text/Symbol/Molecule) oriented towards Large Language Models (LLMs) and Machine Learning (ML). 
